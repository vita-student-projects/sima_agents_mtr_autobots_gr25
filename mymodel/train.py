...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default='cfgs/waymo/mtr+20_percent_data.yaml', help='specify the config for training')
...
def main():
    ...
    if args.fix_random_seed:
        common_utils.set_random_seed(686)
    ...
    for batch in train_loader:
        ...
        print('input_dict', len(batch['input_dict']))
        print('input_dict', type(batch['input_dict']))
        print('input_dict', batch['input_dict'].keys())
        print('batch_sample_count', len(batch['batch_sample_count']))
